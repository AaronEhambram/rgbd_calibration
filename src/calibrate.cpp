...
int main(int argc, char **argv)
{
  ...
  nh.getParam("calibrate_node/checkerboard_rows", checkerboard_rows);
  nh.getParam("calibrate_node/checkerboard_cols", checkerboard_cols);
  nh.getParam("calibrate_node/folder_path", folder_path);
  nh.getParam("calibrate_node/check_side_length", check_side_length);
  ...
  rgb_calibration_results_file << folder_path << "/rgb_camera.txt"; 
  ...
  ir_calibration_results_file << folder_path << "/ir_camera.txt"; 
  ...
  calibration_results_file << folder_path << "/rgbd_calibration.txt"; 
  cv::FileStorage file(calibration_results_file.str(), cv::FileStorage::WRITE);
